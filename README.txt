...
which include input and output video characteristics 
along with their transcoding 
...
i7-3720QM CPU through randomly picking two rows from the first dataset 
and using 
